...
namespace CalculateWater
{
    class GrantServices
    {
        ...
        public GrantServices(SqlConnection conn, int pId)
        {
            this.Id = 0;
            this.PeriodOt = "";
            this.PeriodDo = "";
            ...
            string sql = "SELECT Id, PeriodOt, PeriodDo, TypeChargeID, ConsumptionRate, Coefficient, TypeServicesID FROM GrantServices WHERE Id = @Id";
